...
import com.example.sandeep.myapplication.listeners.EggListener;
...
public class Adapter_Eggs extends RecyclerView.Adapter<AdapterViewHolder> {
    Activity activity;
    ...
    public Adapter_Eggs(Activity activity, List<Product_Result> list) {
    ...
    public void onBindViewHolder(AdapterViewHolder holder, int position) {
        ...
        holder.llitemview.setOnClickListener(new EggListener(activity,position,price));
    }
