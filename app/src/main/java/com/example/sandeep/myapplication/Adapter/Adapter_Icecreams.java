...
public class Adapter_Icecreams extends RecyclerView.Adapter<AdapterViewHolder> {
    Activity activity;
    ...
    public Adapter_Icecreams(Activity activity, List<Product_Result> list) {
    ...
    public void onBindViewHolder(AdapterViewHolder holder, int position) {
       ...
       // String name = list.get(position).getName();
        holder.llitemview.setOnClickListener(new SweetItemClickListener(activity,position,price));
    }
